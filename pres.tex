...
\usepackage[uniWZ, blockBG, tams, engl, conference]{tamsBeamer}
%-----------------------------------------------------------------------------
%-- options		------------------------------------------------------
...
%\small
\tableofcontents
%\hspace{32ex}\vspace{38ex}{\includegraphics[width=5cm]{img/a3002.png}}
 % \tableofcontents[pausesections]	% step through sections

\end{frame}

% GAZEBO Referenz
%Nathan Koenig, Andrew Howard ``Design and Use Paradigms for Gazebo, An
%Open-Source Multi-Robot Simulator'', Proceedings of 2004 IEEE/RSJ International Conference on
%Intelligent Robots and Systems, September 28 - October 2, 2004, Sendai, Japan.
